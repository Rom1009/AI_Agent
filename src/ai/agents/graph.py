...
from src.ai.agents.nodes import (
    load_config,
    load_profile,
    generate_queries,
    web_search,
...
def build_graph():
    ...
    builder.add_node("filter_nodes", filter_nodes)
    ...
    builder.add_edge("web_search", "filter_nodes")
    builder.add_edge("filter_nodes", "filter_docs")
